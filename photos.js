...
function previewFive() {
  ...
  //disable the 'showmore images' button after it has been selected once
...
/*******************************************************************************************************/
//create event listeners for left arrow, right arrwo, and fiveButton elements
...
function createEventListeners() {
    ...
    //the left Arrow() function will be executed when the user clicks the left navigation arrow button
    ...
    //therightArrow() function will be executed when user clicks the right navigation arrow
